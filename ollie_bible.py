...
# Filling data path
data_path = "c:/Users/gatla/OneDrive/BSE/Computational_machine_learning/Project_1/ML_house_price_prediction_project/data/train.csv"
...
df_no_binary = df[['id','num_rooms', 'num_baths', 'square_meters', 'year_built', 'floor', 'num_crimes', 'neighborhood_crime_encoded']]
...
# Test data import
data_path_test = "C:/Users/gatla/OneDrive/BSE/Computational_machine_learning/Project_1/ML_house_price_prediction_project/data/test.csv"
...
x_test = df_not_missing[['num_rooms', 'num_baths', 'square_meters', 'year_built', 'floor', 'num_crimes', 'neighborhood_crime_encoded', 'is_furnished', 'has_pool', 'num_crimes', 'has_ac', 'accepts_pets']]
y_pred_not_missing = model.predict(x_test)

df_not_missing['pred'] = y_pred_not_missing

# Prediction for df_missing
x_test = df_missing[['id','num_rooms', 'num_baths', 'square_meters', 'year_built', 'floor', 'num_crimes', 'neighborhood_crime_encoded']]
...
new_df.to_csv("C:/Users/gatla/OneDrive/BSE/Computational_machine_learning/Project_1/ollie_pred.csv", index=False)
